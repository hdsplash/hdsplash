...
import com.binhnv.hdsplash.fragments.DirectoryChooserFragment;
import com.binhnv.hdsplash.fragments.ImagesFragment;
import com.binhnv.hdsplash.models.MyImage;
import com.binhnv.hdsplash.other.CustomAnimatorListener;
import com.binhnv.hdsplash.other.CustomTransitionListener;
import com.binhnv.hdsplash.other.PaletteTransformation;
import com.binhnv.hdsplash.other.Utils;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.binhnv.hdsplash.R.layout.activity_detail);

        findViewById(com.binhnv.hdsplash.R.id.container).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        final ImageView image = (ImageView) findViewById(com.binhnv.hdsplash.R.id.activity_detail_image);
        ...
        if (!sp.getBoolean("help-understand", false)) {
            Snackbar.with(getApplicationContext())
                    .text(com.binhnv.hdsplash.R.string.help_try_long_click)
                    .actionLabel(com.binhnv.hdsplash.R.string.help_try_long_click_ok)
                    .actionColorResource(com.binhnv.hdsplash.R.color.accent)
        ...
        public void onClick(View v) {
            if (future == null) {
                if (!Utils.isExternalStorageWritable()) {
                    Toast.makeText(DetailActivity.this, com.binhnv.hdsplash.R.string.error_no_storage, Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void animateActivityStart() {
        ...
        showTitleAnimator.setListener(new CustomAnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                super.onAnimationEnd(animation);
                mTitlesContainer.startAnimation(AnimationUtils.loadAnimation(DetailActivity.this, com.binhnv.hdsplash.R.anim.alpha_on));
    ...
    private void setColors(int titleTextColor, int rgb) {
        ...
        TextView titleTV = (TextView) mTitleContainer.findViewById(com.binhnv.hdsplash.R.id.activity_detail_title);
        titleTV.setTextColor(titleTextColor);
        titleTV.setText(mSelectedImage.getAuthor());

        TextView subtitleTV = (TextView) mTitleContainer.findViewById(com.binhnv.hdsplash.R.id.activity_detail_subtitle);
        subtitleTV.setTextColor(titleTextColor);
        //subtitleTV.setText(mSelectedImage.getReadableModified_Date());

        ((TextView) mTitleContainer.findViewById(com.binhnv.hdsplash.R.id.activity_detail_subtitle))
